import { regions, countries, specialties, subSpecialties } from './mockData.js';
...
export type Country = typeof countries[Region][number];

export type CountriesMap = Record<Region, readonly Country[]>;

export type Specialty = typeof specialties[number];

export type SubSpecialty = typeof subSpecialties[Specialty][number];
